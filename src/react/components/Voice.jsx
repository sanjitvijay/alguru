    ...
    <div>
      ...
      <div className="text-center mb-5">
        ...
        <div className="flex items-center justify-between">
          <InfoCard
            icon={<FaQuestion size={20} color={"#ec4899"} />}
            text={"Simulate a real coding interview"}
          />
          <InfoCard
            icon={<FaBug size={20} color={"#ef4444"} />}
            text={"Get debugging help"}
          />
          <InfoCard
            icon={<FaRegLightbulb size={20} color={"#f59e0b"} />}
            text={"Ask for hints"}
          />
        </div>
      </div>
      ...
      {isVoiceAvailable && (
        <div className="flex justify-center items-center">
          ...
          >
            <div className="bg-base-100 text-center w-full h-full rounded-full flex justify-center items-center px-2">
          ...
          <div>
            {listening && (
              <CircleStop
                className="w-8 h-8 ml-2 text-error hover:w-9 hover:h-9"
                strokeWidth={1.5}
      ...
      <div className="flex justify-center items-end mt-16 h-10">
        {listening && (
          <>
            <div className="text-xl font-bold mr-1">Listening</div>
        ...
        {thinking && (
          <>
            <div className="text-xl font-bold mr-1">Thinking</div>
            <div className="loading loading-dots loading-sm"></div>
          </>
        )}
      </div>
      ...
      <div className="prose">
        ...
        {responseText && !thinking && (
          <div className="text-md">Alguru: {responseText}</div>
        )}
      </div>
    </div>
  );
