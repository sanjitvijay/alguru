...
export const VoiceChatProvider = ({ children }) => {
  ...
  const { title, code, language, audio, setAudio, incrementVoiceUsage } =
    useAppContext();

  const [thinking, setThinking] = useState(false);
  const [responseText, setResponseText] = useState("");

  const instructions = `You are a voice chatbot helping a student solve a leetcode problem to prepare for a coding interview.
